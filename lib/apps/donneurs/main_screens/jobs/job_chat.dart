...
class JobChat extends StatefulWidget {
  ...
  const JobChat({super.key, required this.presta});

  @override
  State<JobChat> createState() => _JobChatState();
}

class _JobChatState extends State<JobChat> with WidgetsBindingObserver {
  ...
  PreferredSizeWidget _buildAppBar() {
    final avatar = (widget.presta.imageUrl.isNotEmpty
        ? NetworkImage(widget.presta.imageUrl.first)
        : null);
    return AppBar(
      elevation: 0,
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(fontSize: 12, color: colors.bg),
                ),
              ],
            ),
          ),
      ...
      //     icon: Icon(Icons.videocam, color: colors.bg),
      //   ),
      //   IconButton(
