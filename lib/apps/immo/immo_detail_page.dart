...
class _ImmoDetailPageState extends State<ImmoDetailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomSheet: _buildActionDashboard(house),
    );
  }
                    ...
                    MaterialPageRoute(
                      builder: (context) => ChatWidget(
                        ...
                        message: SendMessageModel(
                          ...
                          userPhoto: Config.getImgUrl(house.logo),
                          content: '',
  ...
  Widget _buildActionDashboard(HouseModel house) {
    return Container(
        ...
        children: [
          ...
          Expanded(
            ...
            child: ElevatedButton.icon(
              ...
              label: const Text("Booster le post"),
