...
class ImmoBoostPage extends StatefulWidget {
  final HouseModel boost;
  const ImmoBoostPage({super.key, required this.boost});

  @override
  State<ImmoBoostPage> createState() => _ImmoBoostPageState();
}

class _ImmoBoostPageState extends State<ImmoBoostPage>
