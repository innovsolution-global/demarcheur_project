...
import 'package:demarcheur_app/apps/demandeurs/main_screens/dem_chat.dart';
...
class DemMessage extends StatefulWidget {
  ...
  @override
  State<DemMessage> createState() => _ImmoMessagePageState();
}

class _ImmoMessagePageState extends State<DemMessage>
  ...
  void _navigateToChat(dynamic conversation) {
    ...
    if (conversation is ChatRoom) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => DemChat(presta: house)),
      );
    }
  }
}
