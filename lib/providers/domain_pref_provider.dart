...
class DomainModel {
  ...
  DomainModel({required this.id, required this.name, required this.category});
}
  ...
  final List<Map<String, dynamic>> _categories = [
    {
      ...
      'domains': [
        DomainModel(
          ...
          category: 'Ingénierie logicielle et Informatique',
        ),
        DomainModel(
          id: '2',
    ...
    },
    {
      ...
      'domains': [
        DomainModel(
          id: '13',
          name: 'Cyber sécurité',
          category: 'Ingénierie cyber sécurité et Informatique',
        ),
        DomainModel(
          id: '14',
    ...
    },
    {
      ...
      'domains': [
        DomainModel(
          id: '87',
          name: 'Architecture',
          category: 'Architecture et Construction',
        ),
        DomainModel(
          id: '88',
          name: 'Génie civil',
    ...
    },
    {
      ...
      'domains': [
        DomainModel(
          ...
          category: 'Ingénierie et Industrie',
        ),
        DomainModel(
          id: '96',
    ...
    },
    {
      ...
      'domains': [
        DomainModel(
          id: '117',
          name: 'Agriculture',
          category: 'Agriculture et Agroalimentaire',
        ),
        DomainModel(
          id: '118',
          name: 'Élevage',
    ...
    },
    {
      ...
      'domains': [
        DomainModel(
          id: '121',
          name: 'Journalisme',
          category: 'Médias et Journalisme',
        ),
        DomainModel(
          id: '122',
          name: 'Rédaction',
    ...
    },
    {
      ...
      'domains': [
        ...
        DomainModel(
          id: '129',
          name: 'Conseil en transformation',
          category: 'Conseil et Stratégie',
        ),
        DomainModel(
          id: '130',
